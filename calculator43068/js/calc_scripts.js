...
jQuery(document).ready(function() {
      ...
      var Conacts = '';
      var i=0;
      var basic = [20,40,60,80,100,200,320,520,680,880,1000,1200];
      var email = [5000,10000,15000,20000,25000,50000,75000,100000,125000,150000,200000,250000];
      var unlimited = [80,120,180,240,300,440,720,1000,1280,1520,1800,2000];
      var nt = [20,28,36,44,52,76,88,100,112,124,140,156];
      var bot = [8,12,16,26,24,36,44,52,60,68,76,76];
    ...
    function totalCost(option,isCustom){
      ...
      var cartDetails = $('.contacts strong').text()+' (Unique Contacts)';
          ...
          cartDetails += ' + '+$('.nt strong').text()+' (Nurture Track / Workflows)' + ' + ' + $('.auto strong').text() + ' (Autobot)';
      $('#cartDetails').val(cartDetails);
      $('#cartUC').val($('.contacts strong').text()+' Unique Contacts');
      $('#cartEs').val($('.mails strong').text()+' Emails');
      $('#cartNA').val($('.nt strong').text()+' Nurture Track / Workflows ' + ' + ' + $('.auto strong').text() + ' Autobot');
    }
    /*==============
        Loading Function
    =================*/
