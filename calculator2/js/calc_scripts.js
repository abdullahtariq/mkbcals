jQuery(document).ready(function() {
    ...
    function initialize(){
      ...
      _totalCost =  rangeValue * Price[range];
      //console.log('Total Cost : '+ Math.round(_totalCost));

      if(range != -1){
      $('.contacts strong').html(commaSeparateNumber($('#rangeValue').val()));
      $('#total_cost').html('$'+Math.round(_totalCost));
      $('#cartPrice').val(Math.round(_totalCost));
      $('#cartDetails').val(Math.round(_totalCost)+' Emails Sent/Month');
      $('#cartUC').val(Math.round(_totalCost)+' Emails Sent/Month');
    ...
    function calculateRange(){
      if( 1 <= rangeValue && rangeValue <= 100000)
         {i = 0;Conacts='1 - 1000';}
      else if( 100001 <= rangeValue && rangeValue <= 500000)
         {i = 1;Conacts='1001 - 2000';}
      else if( 500001 <= rangeValue && rangeValue <= 1000000)
         {i= 2;Conacts='2001 - 3000';}
      else if( rangeValue >= 1000001)
